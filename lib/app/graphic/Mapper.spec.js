...
describe('Edges', () => {
    describe('getEdges()', () => {
        it('should filter edges', () => {
            const vert = Mapper_1.Mapper.vertices(3, 3);
            const result = Mapper_1.Edges.getEdges(vert);
            const expected = [
                { x: 0, y: 0, z: 0 },
                { x: 0, y: 3, z: 0 },
                { x: 3, y: 0, z: 0 },
        ...
        it('should filter edges with more values', () => {
            const vert = Mapper_1.Mapper.vertices(5, 3);
            const result = Mapper_1.Edges.getEdges(vert);
            const expected = [
                { x: 0, y: 0, z: 0 },
                { x: 0, y: 3, z: 0 },
...
describe('Indices', () => {
    describe('calcIndices()', () => {
        it('should indice with 2', () => {
            ...
            const actual = Mapper_1.Indices.calcIndices(2);
        ...
        it('should indice with 3', () => {
            ...
            const actual = Mapper_1.Indices.calcIndices(3);
            chai_1.expect(expected).to.be.deep.equal(actual);
        });
    });
});
describe('Mapper', () => {
    describe('uv()', () => {
        it('should generate uv', () => {
            const result = Mapper_1.Mapper.uv(2);
            const expected = [
                { x: 0, y: 0, z: 0 },
                { x: 0, y: 1, z: 0 },
                { x: 1, y: 0, z: 0 },
    ...
    describe('vertices()', () => {
        it('should generate vertices 4', () => {
            ...
            const result = Mapper_1.Mapper.vertices(4, 2);
            chai_1.expect(expected).to.be.deep.equal(result);
        });
    });
    describe('map()', () => {
        it('should shift vertices one to bottom left', () => {
            ...
            const result = Mapper_1.Mapper.map(4, points[0], points[1], points[2], points[3]);
            chai_1.expect(expected).to.be.deep.equal(result);
        });
